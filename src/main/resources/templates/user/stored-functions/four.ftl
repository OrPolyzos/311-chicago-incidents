...
<html>
<head>
    <title>Average completion time per type in range</title>
...
<div class="container" style="position: relative;">
    <form class="form-inline text-center" role="form" action="/user/sf/avg-completion-time-in-range" method="POST" name="searchForm">
        ...
        <#if results??>
            <#list results as result>
                <tr>
                    ...
                    <td class="text-center">${result.avgCompletionTime?c?number}</td>
                </tr>
            </#list>
        </#if>
        </tbody>
