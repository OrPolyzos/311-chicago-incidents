...
<html>
<head>
    <title>Requests per type in range</title>
...
<div class="container" style="position: relative;">
    <form class="form-inline text-center" role="form" action="/user/sf/requests-per-type-in-range" method="POST" name="searchForm">
