<#--<input type="hidden" id="create-user-modal-js" value="${createUserModalJs!""}"/>-->
  <#--<!-- Modal &ndash;&gt;-->
  <#--<div class="modal fade" id="create-user-modal" role="dialog">-->
      <#--<div class="modal-dialog modal-lg">-->
          <#--<form class="form-horizontal" action="/admin/users" method="POST" id="userCreateForm" name="userCreateForm">-->
